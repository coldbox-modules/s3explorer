...
<!------------------------------------------- CONSTRUCTOR ------------------------------------------>
	...
	<cffunction name="init" access="public" returnType="AmazonS3" output="false" hint="Constructor">
		...
		<cfscript>
			...
			if( not settingExists("s3_secretKey") ){
				$throw(message="s3_secretKey setting not defined, please define it.",type="s3.invalidSettings");
			}
			if( not settingExists("s3_encryption_charset") ){
				setSetting("s3_encryption_charset","utf-8");
			}
	...
	<!--- setSSL --->
    <cffunction name="setSSL" output="false" access="public" returntype="void" hint="Set SSL flag or not">
    	<cfargument name="useSSL" type="boolean" required="false" default="true" hint="Set to true or false"/>
    	<cfscript>
			if( arguments.useSSL ){ instance.URLEndPoint = "https://s3.amazonaws.com"; }
...
<!------------------------------------------- PRIVATE ------------------------------------------>
	...
	<cffunction name="HMAC_SHA1" returntype="binary" access="private" output="false" hint="NSA SHA-1 Algorithm: RFC 2104HMAC-SHA1 ">
		<cfargument name="signKey"     type="string" required="true" />
	   	...
	   	<cfscript>
			var jMsg = JavaCast("string",arguments.signMessage).getBytes(instance.encryptionCharSet);

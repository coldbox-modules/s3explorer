<cfoutput>
<h1><img src="#prc.root#/includes/images/disks.png" alt="disks" /> My Amazon S3 Buckets</h1>
	...
	<ul>
		<li>
			<a href="javascript:createBucket()" class="hotbutton">
				<span><img src="#prc.root#/includes/images/add.png" alt="add" border="0" /> Create Bucket</span>
			</a>
		</li>
		<li>
...
<tr>
	<td>
		<a href="#event.buildLink( 's3explorer.bucket.' & '#URLEncodedFormat( bucket.Name )#' )#"
		   title="Go into bucket">
		   <img src="#prc.root#/includes/images/folder.gif" alt="folder" border="0" />#bucket.Name#
		</a>
	</td>
	<td>
	...
	<td class="center">
		<a href="#event.buildLink( 's3explorer.explorer.viewBucket.bucketName.' & URLEncodedFormat( bucket.Name ) )#"
		   title="Go into bucket">
			<img src="#prc.root#/includes/images/view.png" border="0" alt="view" />
		</a>
		...
		<a href="#event.buildLink( 's3explorer.explorer.removeBucket.bucketName.' & URLEncodedFormat( bucket.Name ) )#" 
		   ...
		   title="Remove object">
			<img src="#prc.root#/includes/images/delete.png" border="0" alt="delete" />
		</a>
	</td>
</tr>
</cfloop>
...
function showACL( bucket ){
	...
	$( "##dialog" ).load( 
		'#event.buildLink("s3explorer.explorer.objectACL")#',
		data,
		function(){
